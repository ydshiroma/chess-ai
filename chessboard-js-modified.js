/*! chessboard.js v1.0.0 | Modified for 6x6 board */
!(function () {
  "use strict";
  var z = window.jQuery,
    F = "abcdef".split(""),  // Changed from "abcdefgh"
    r = 20,
    A = "…",
    W = "1.8.3",
    e = "rnkqnr/pppppp/6/6/PPPPPP/RNKQNR",  // Changed from standard 8x8
    G = pe(e),
    n = 200,
    t = 200,
    o = 60,
  ...
  function oe(e) {
    return re(e) && -1 !== e.search(/^[a-f][1-6]$/);  // Changed from [a-h][1-8]
  }
  function u(e) {
    return re(e) && -1 !== e.search(/^[bw][KQRNP]$/);  // Removed B for bishop
  }
  function ae(e) {
    if (!re(e)) return !1;
    var r = (e = (function (e) {
      return e
        .replace(/6/g, "111111")  // Changed from 8->11111111
        .replace(/5/g, "11111")
        .replace(/4/g, "1111")
        .replace(/3/g, "111")
        .replace(/2/g, "11");
    })((e = e.replace(/ .+$/, "")))).split("/");
    if (6 !== r.length) return !1;  // Changed from 8
    for (var n = 0; n < 6; n++)  // Changed from 8
      if (6 !== r[n].length || -1 !== r[n].search(/[^kqrnpKQRNP1]/))  // Changed from 8, removed B/b
        return !1;
    return !0;
  }
  function ie(e) {
  ...
  function ce(e) {
    ...
    for (var r, n, t = "", o = 6, a = 0; a < 6; a++) {  // Changed from 8
      ...
      5 !== a && (t += "/"), (o -= 1);  // Changed from 7
    }
    return (t = (function (e) {
      return e
        .replace(/111111/g, "6")  // Changed from 11111111->8
        .replace(/11111/g, "5")
        .replace(/1111/g, "4")
        .replace(/111/g, "3")
        .replace(/11/g, "2");
  ...
  function ue(e, r, n) {
    for (
      var t = (function (e) {
          for (var r = [], n = 0; n < 6; n++)  // Changed from 8
            for (var t = 0; t < 6; t++) {  // Changed from 8
              var o = F[n] + (t + 1);
              e !== o &&
                r.push({
                  square: o,
  ...
  (H.alpha = "alpha-d2270"),
    ...
    (window.Chessboard = function (e, f) {
      ...
      function x(e) {
        var r = ["wK", "wQ", "wR", "wN", "wP"];  // Removed wB
        "black" === e && (r = ["bK", "bQ", "bR", "bN", "bP"]);  // Removed bB
      ...
      function q() {
        r.html(
          (function (e) {
            ...
            for (var o = "white", a = 0; a < 6; a++) {  // Changed from 8
              r += '<div class="{row}">';
              for (var i = 0; i < 6; i++) {  // Changed from 8
                var s = n[i] + t;
      ...
      (i.clear = function (e) {
        ...
        (i.resize = function () {
          (b = (function () {
            ...
            if (!e || e <= 0) return 0;
            for (var r = e - 1; r % 6 != 0 && 0 < r; ) r -= 1;  // Changed from 8
            return r / 6;  // Changed from 8
          })()),
            r.css("width", 6 * b + "px"),  // Changed from 8
        ...
        (function () {
          !(function () {
            for (var e = 0; e < F.length; e++)
              for (var r = 1; r <= 6; r++) {  // Changed from 8
                var n = F[e] + r;
                g[n] = n + "-" + Z();
              }
            var t = "KQRNP".split("");  // Removed B
